...
const styles = {
  ...
  input:     { width: '100%', background: '#111827', border: '1px solid #252d42', borderRadius: 8, padding: '11px 14px', color: '#e2e8f0', fontSize: 14, marginBottom: 18, display: 'block', boxSizing: 'border-box' },
  ...
  eyeBtn:    { position: 'absolute', right: 12, top: '50%', transform: 'translateY(-50%)', background: 'transparent', border: 'none', color: '#475569', cursor: 'pointer', padding: 2, display: 'flex', alignItems: 'center' },
};